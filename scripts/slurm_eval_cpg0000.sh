python submitit_train.py \
    ...
    --skewed_timesteps \
    --fid_samples=30720 \
    --job_dir=/share/pi/syyeung/yuhuiz/Cell/MorphFlow/examples/image/output_dir_eval_cpg0000_100_class_cfg0.2 \
    --shared_dir=/share/pi/syyeung/yuhuiz/Cell/MorphFlow/examples/image/shared/ \
    --use_initial=2 \
    --eval_only \
    --noise_level=1.0 \
    --save_fid_samples \
    --resume=/share/pi/syyeung/yuhuiz/Cell/MorphFlow/examples/image/20250125_1754_cpg0000_noise1.0_drop0.2_cfg0.2_prob0.5/checkpoint-79.pth \
    --start_epoch 79 \
    --ngpus=4 \
